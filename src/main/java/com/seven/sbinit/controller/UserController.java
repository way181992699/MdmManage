...
import com.seven.sbinit.service.*;
import com.seven.sbinit.utils.ConfigUtils;
import com.seven.sbinit.utils.EmailUtil;
import com.seven.sbinit.utils.MDMTaskUtils;
import com.seven.sbinit.utils.StringUtil;
import com.seven.sbinit.vo.AdminVO;
        ...
        if (ismobile) {
            ...
            if (null != user) {
                ...
                String content = "用户 " + email + " 您好：<br/><br/>描述文件下载地址："
                        + "<a href='http://localhost:8080/OpenMDMServer/user/download.do?uid=" + id + "' target='_blank'>http://localhost:8080/OpenMDMServer/user/download.do?uid=" + id + "</a><br/>"
                        + "描述文件二维码地址：<br/><img src='http://qr.topscan.com/api.php?el=l&w=200&m=10&text=http://localhost:8080/OpenMDMServer/user/download.do?uid=" + id + "'/><br/>"
                        + "平台登录地址：<a href='http://localhost:8080/OpenMDMServer/sysadmin/login.jsp' target='_blank'>http://localhost:8080</a>，登录账号是：" + email + "，登录密码是：" + id + "</br>"
